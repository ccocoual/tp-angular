...
export class AppComponent {
  total = 0;
  products: Product[] = [
    {"title": "Sweat homme", "description": "<C0D1NG_TH3_W0RLD> SWEATSHIRT CHAUD BIO À CAPUCHE - HOMME", "photo": "https://s3.eu-central-1.amazonaws.com/balibart-s3/Products/5acf344514006a7fe670e2eb/Mockups/front.png", "price": 39},
    {"title": "Tee-Shirt homme", "description": "TEE-SHIRT BIO À COL ROND - HOMME", "photo": "https://s3.eu-central-1.amazonaws.com/balibart-s3/Products/5b2911e4ab33424aec592bd6/Mockups/front.png", "price": 19},
