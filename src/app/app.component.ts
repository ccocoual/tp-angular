...
export class AppComponent {
  ...
  products: Product[] = [
    ...
    {"title": "Tee-Shirt homme", "description": "TEE-SHIRT BIO À COL ROND - HOMME", "photo": "https://s3.eu-central-1.amazonaws.com/balibart-s3/Products/5b2911e4ab33424aec592bd6/Mockups/front.png", "price": 19, stock: 0},
